...
namespace Bendiciones
{
    public partial class frmGestionarCurso : Form
    {
		...
		public bool verificarCampos()
		{
			...
			{
				MessageBox.Show("Añada un precio válido", "Error en Precio", MessageBoxButtons.OK, MessageBoxIcon.Error);
				return false;
			}
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
			if (verificarCampos())
			{
				...
				if (estadoObjCur == Estado.Nuevo)
				{
					...
					MessageBox.Show("Curso Registrado exitosamente", "Mensaje Confirmacion", MessageBoxButtons.OK, MessageBoxIcon.Information);
				}
